...
Project scaffold for Week 5 Activity
...
Then, the the generated code will be executed as *`node dist/week-5-design-patterns-starter.js
week-5-design-patterns-starter.js`*.  
...
To execute the code, run *`node dist/week-5-design-patterns-starter.js
week-5-design-patterns-starter.js`*.  
*Note:* The default Entry point for project is set to `index.ts` and can be modified in `package.json`.
