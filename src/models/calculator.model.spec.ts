...
describe('CalculatorModel', (): void => {
  ...
  it('should display `13` when equals is clicked on `7 + 6 - 7`', (): void => {
  ...
  it("should display '14' when equals is clicked on '2 + 3 * 4'", () => {
    calculator.pressNumericKey(NumericKeys.TWO);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
    calculator.pressNumericKey(NumericKeys.THREE);
    calculator.pressOperatorKey(OperatorKeys.MULT);
  ...
  it("should display '10' when equals is clicked on '2 * 3 + 4'", () => {
    calculator.pressNumericKey(NumericKeys.TWO);
    calculator.pressOperatorKey(OperatorKeys.MULT);
    calculator.pressNumericKey(NumericKeys.THREE);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
  ...
  it("should display '3' when equals is clicked on '2 * 3 / 2'", () => {
    calculator.pressNumericKey(NumericKeys.TWO);
    calculator.pressOperatorKey(OperatorKeys.MULT);
    calculator.pressNumericKey(NumericKeys.THREE);
    calculator.pressOperatorKey(OperatorKeys.DIV);
  ...
  it("should display '56' when equals is clicked on '20 + 3 * 12'", () => {
    calculator.pressNumericKey(NumericKeys.TWO);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
    calculator.pressNumericKey(NumericKeys.THREE);
  ...
  it("should display '90' when equals is clicked on '100 + 200 / 10 - 3 * 10'", () => {
    calculator.pressNumericKey(NumericKeys.ONE);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
  ...
  it("should display '700' when equals is clicked on '100 + 200 / 10 * 3 * 10'", () => {
    calculator.pressNumericKey(NumericKeys.ONE);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
    ...
    expect(displayValue).toEqual('700');
  })

  it("should display '170' when equals is clicked on '100 + 200 / 10 * 3 + 10'", () => {
    calculator.pressNumericKey(NumericKeys.ONE);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressNumericKey(NumericKeys.ZERO);
    calculator.pressOperatorKey(OperatorKeys.PLUS);
    ...
    expect(displayValue).toEqual('170');
  })
